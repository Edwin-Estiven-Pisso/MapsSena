...
public class MapaNormal extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_normal);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);  // <--- AQUI CAMBIAMOS EL ESTILO DEL MAPA
